...
Block_Pattern::add_pattern_args( __FILE__, array(
	'title'    => sprintf(
		...
		_x( 'Team page: %1$s%2$s', 'Block pattern title.', 'zooey' ),
		_x( '2. With team members list with sticky desription and some stats', 'Page content context.', 'zooey' ),
...
<!-- wp:pattern {"slug":"zooey/intro/intro-07"} /-->

<!-- wp:spacer {"height":"var:preset|spacing|l"} --><div style="height:var(--wp--preset--spacing--l)" aria-hidden="true" class="wp-block-spacer"></div><!-- /wp:spacer -->
...
<!-- wp:pattern {"slug":"zooey/team/team-01"} /-->

<!-- wp:spacer {"height":"var:preset|spacing|content"} --><div style="height:var(--wp--preset--spacing--content)" aria-hidden="true" class="wp-block-spacer"></div><!-- /wp:spacer -->

<!-- wp:pattern {"slug":"zooey/numbers/numbers-05"} /-->
