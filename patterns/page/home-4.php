...
Block_Pattern::add_pattern_args( __FILE__, array(
	'title'    => sprintf(
		...
		_x( '4. With tiled categories', 'Page content context.', 'zooey' ),
...
<!-- wp:pattern {"slug":"zooey/call-to-action/cta-15"} /-->
...
<!-- wp:pattern {"slug":"zooey/call-to-action/cta-06"} /-->

<!-- wp:pattern {"slug":"zooey/gallery/gallery-04"} /-->
