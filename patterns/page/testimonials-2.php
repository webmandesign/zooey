...
Block_Pattern::add_pattern_args( __FILE__, array(
	'title'    => sprintf(
		...
		_x( '2. Intro with call to action, quotes in columns, partner logos', 'Page content context.', 'zooey' ),
...
<!-- wp:pattern {"slug":"zooey/intro/intro-08"} /-->

<!-- wp:pattern {"slug":"zooey/testimonials/testimonials-01"} /-->
...
<!-- wp:pattern {"slug":"zooey/testimonials/testimonials-06"} /-->
