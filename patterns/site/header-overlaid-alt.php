...
Block_Pattern::add_pattern_args( __FILE__, array(
	'title'    => sprintf(
		...
		_x( 'Overlaid with navigation next to logo', 'Site header context.', 'zooey' )
	),
	'keywords' => array(
...
<!-- wp:group {"style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"0.62em","bottom":"0.62em"}},"border":{"bottom":{"width":"1px"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white","className":"has-global-padding","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-global-padding has-white-color has-text-color has-link-color" style="border-bottom-width:1px;margin-top:0;padding-top:0.62em;padding-bottom:0.62em">
