...
<!-- wp:cover {"url":"<?php echo esc_url_raw( $image ); ?>","dimRatio":60,"overlayColor":"black","isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","align":"full","style":{"spacing":{"padding":{"top":"10em","bottom":"var:preset|spacing|content"}}},"layout":{"type":"constrained"},"className":"is-style-zoom-in"} -->
<div class="wp-block-cover alignfull is-style-zoom-in" style="padding-top:10em;padding-bottom:var(--wp--preset--spacing--content);min-height:100vh">
			...
			<div class="wp-block-column" style="padding-top:12vh;flex-basis:61.8%">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-buttons">
						<!-- wp:button {"textColor":"white","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}}} -->
						<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-text-color has-link-color wp-element-button" href="#0"><?php Block_Pattern::the_text( 'button' ); ?></a></div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
