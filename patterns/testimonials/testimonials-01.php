...
<div class="wp-block-group alignfull has-primary-background-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--content);padding-bottom:0">
	...
	<h2 class="wp-block-heading is-style-screen-reader-text"><?php Demo::The_text( 'title/s' ); ?></h2>
	<!-- /wp:heading -->
	...
	<figure class="wp-block-image size-large is-style-padding-left"><img src="<?php echo esc_url_raw( $image ); ?>" alt="<?php echo esc_attr( Demo::Get_text( 'alt' ) ); ?>"/></figure>
	<!-- /wp:image -->
