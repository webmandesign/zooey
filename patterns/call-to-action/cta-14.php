...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<!-- wp:cover {"url":"<?php echo esc_url_raw( $image_1 ); ?>","dimRatio":70,"overlayColor":"primary","minHeight":62,"minHeightUnit":"vh","style":{"border":{"radius":"0.38rem"},"spacing":{"blockGap":"var:preset|spacing|s","padding":{"top":"var:preset|spacing|content","bottom":"var:preset|spacing|content"}}},"className":"is-style-hover-content","layout":{"type":"constrained","contentSize":"240px"}} -->
			<div class="wp-block-cover is-style-hover-content" style="border-radius:0.38rem;padding-top:var(--wp--preset--spacing--content);padding-bottom:var(--wp--preset--spacing--content);min-height:62vh">
				...
				<div class="wp-block-cover__inner-container">
					...
					<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"500"}},"fontSize":"s"} -->
					<h3 class="wp-block-heading has-text-align-center has-s-font-size" style="font-style:normal;font-weight:500;text-transform:uppercase"><?php Block_Pattern::the_text( 'title/s' ); ?></h3>
					<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:cover {"url":"<?php echo esc_url_raw( $image_2 ); ?>","dimRatio":70,"overlayColor":"primary","minHeight":62,"minHeightUnit":"vh","style":{"border":{"radius":"0.38rem"},"spacing":{"blockGap":"var:preset|spacing|s","padding":{"top":"var:preset|spacing|content","bottom":"var:preset|spacing|content"}}},"layout":{"type":"constrained","contentSize":"240px"}} -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:cover {"url":"<?php echo esc_url_raw( $image_3 ); ?>","dimRatio":70,"overlayColor":"primary","minHeight":62,"minHeightUnit":"vh","style":{"border":{"radius":"0.38rem"},"spacing":{"blockGap":"var:preset|spacing|s","padding":{"top":"var:preset|spacing|content","bottom":"var:preset|spacing|content"}}},"className":"is-style-hover-content","layout":{"type":"constrained","contentSize":"240px"}} -->
			<div class="wp-block-cover is-style-hover-content" style="border-radius:0.38rem;padding-top:var(--wp--preset--spacing--content);padding-bottom:var(--wp--preset--spacing--content);min-height:62vh">
				<span aria-hidden="true" class="wp-block-cover__background has-primary-background-color has-background-dim-70 has-background-dim"></span>
