...
<!-- wp:group {"align":"full","style":{"spacing":{"margin":{"top":"0"},"blockGap":{"top":"var:preset|spacing|s","left":"var:preset|spacing|s"},"padding":{"top":"var:preset|spacing|content","bottom":"var:preset|spacing|content"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--content);padding-bottom:var(--wp--preset--spacing--content)">
	...
	<h2 class="wp-block-heading has-text-align-center"><?php Block_Pattern::the_text( 'title/m' ); ?>?</h2>
	<!-- /wp:heading -->
