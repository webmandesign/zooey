...
Block_Pattern::add_pattern_args( __FILE__, array(
	'title'    => _x( 'Fullscreen call to action with highlighted title', 'Block pattern title.', 'zooey' ),
	'keywords' => array(
...
<div class="wp-block-cover alignfull has-white-color has-text-color has-link-color" style="padding-top:var(--wp--preset--spacing--content);padding-bottom:var(--wp--preset--spacing--content);min-height:100vh">
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group alignwide">
			...
			<h2 class="wp-block-heading has-big-font-size" style="line-height:1.3"><mark style="background-color:#5f1a37" class="has-inline-color has-base-color"><?php Block_Pattern::the_text( 'title/l' ); ?></mark></h2>
			<!-- /wp:heading -->
