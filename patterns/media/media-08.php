...
<div class="wp-block-cover alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--content);padding-bottom:var(--wp--preset--spacing--content);min-height:62vh">
	...
	<div class="wp-block-cover__inner-container">
		...
		<p class="has-text-align-center has-supplemental-font-family has-h-1-font-size" style="font-style:normal;font-weight:700;line-height:1.3"><?php Demo::The_text( 'title/l' ); ?></p>
		<!-- /wp:paragraph -->
