...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0">
	...
	<!-- wp:media-text {"align":"wide","mediaId":<?php echo absint( ZOOEY_DUMMY_ID ); ?>,"mediaType":"image","imageFill":true,"style":{"border":{"radius":"0.38rem"}},"backgroundColor":"primary"} -->
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill has-primary-background-color has-background" style="border-radius:0.38rem">
		...
		<div class="wp-block-media-text__content">
			...
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|l","bottom":"var:preset|spacing|l"}},"dimensions":{"minHeight":"62vh"}},"layout":{"type":"flex","orientation":"vertical","verticalAlignment":"center"}} -->
			<div class="wp-block-group" style="min-height:62vh;padding-top:var(--wp--preset--spacing--l);padding-bottom:var(--wp--preset--spacing--l)">
				...
				<p class="has-drop-cap has-l-font-size"><?php Block_Pattern::the_text( '180' ); ?></p>
				<!-- /wp:paragraph -->
