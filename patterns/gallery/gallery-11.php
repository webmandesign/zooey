...
<div class="wp-block-columns alignfull" style="margin-top:0;padding-right:0;padding-left:0">
	...
	<div class="wp-block-column" style="flex-basis:38.2%">
		...
		<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|l","left":"var:preset|spacing|l","top":"var:preset|spacing|content","bottom":"var:preset|spacing|content"}},"dimensions":{"minHeight":"100vh"},"position":{"type":"sticky","top":"0px"}},"backgroundColor":"primary","layout":{"type":"flex","orientation":"vertical","verticalAlignment":"center","justifyContent":"center"}} -->
		<div class="wp-block-group has-primary-background-color has-background" style="min-height:100vh;padding-top:var(--wp--preset--spacing--content);padding-right:var(--wp--preset--spacing--l);padding-bottom:var(--wp--preset--spacing--content);padding-left:var(--wp--preset--spacing--l)">
	...
	<!-- wp:column {"width":"61.8%","style":{"spacing":{"blockGap":"0"}}} -->
	<div class="wp-block-column" style="flex-basis:61.8%">

		<!-- wp:group {"style":{"position":{"type":"sticky","top":"0px"}}} -->
		<div class="wp-block-group">
			<!-- wp:image {"sizeSlug":"large","className":"is-fullwidth"} -->
			<figure class="wp-block-image size-large is-fullwidth"><img src="<?php echo esc_url_raw( $image_1 ); ?>" alt="<?php echo esc_attr( Block_Pattern::get_text( 'alt' ) ); ?>" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			<!-- wp:image {"sizeSlug":"large","className":"is-fullwidth"} -->
			<figure class="wp-block-image size-large is-fullwidth"><img src="<?php echo esc_url_raw( $image_2 ); ?>" alt="<?php echo esc_attr( Block_Pattern::get_text( 'alt' ) ); ?>" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			<!-- wp:image {"sizeSlug":"large","className":"is-fullwidth"} -->
			<figure class="wp-block-image size-large is-fullwidth"><img src="<?php echo esc_url_raw( $image_3 ); ?>" alt="<?php echo esc_attr( Block_Pattern::get_text( 'alt' ) ); ?>" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:group -->
