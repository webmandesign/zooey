...
wp.blocks.registerBlockVariation( 'core/group', {
	...
	title: __( 'Responsive table container', 'zooey' ),
	keywords: [
		_x( 'table', 'keyword', 'zooey' ),
		_x( 'wrapper', 'keyword', 'zooey' ),
		_x( 'container', 'keyword', 'zooey' ),
		_x( 'mobile', 'keyword', 'zooey' ),
		_x( 'responsive', 'keyword', 'zooey' ),
		_x( 'group', 'keyword', 'zooey' ),
	],
