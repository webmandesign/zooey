...
wp.blocks.registerBlockVariation( 'core/query', {
	...
	title: __( 'Blog Posts', 'ileana' ),
	keywords: [
		_x( 'latest posts', 'keyword', 'ileana' ),
		_x( 'news', 'keyword', 'ileana' ),
		_x( 'inline', 'keyword', 'ileana' ),
		_x( 'row', 'keyword', 'ileana' ),
		_x( 'columns', 'keyword', 'ileana' ),
	],
	...
	innerBlocks: [
		[
			...
			[
				...
				[ 'core/pattern', { slug: 'ileana/site/entry-query' } ]
			]
		],
	]
} );
...
wp.blocks.registerBlockVariation( 'core/query', {
	...
	title: __( 'Alternative Posts', 'ileana' ),
	keywords: [
		_x( 'latest posts', 'keyword', 'ileana' ),
		_x( 'news', 'keyword', 'ileana' ),
		_x( 'inline', 'keyword', 'ileana' ),
	...
	innerBlocks: [
		[
			...
			[
				// Can not use `core/template-part` block here
				// as it is not available in post/page editor.
				[ 'core/pattern', { slug: 'ileana/site/entry-query-alt' } ]
			]
		],
	]
} );
